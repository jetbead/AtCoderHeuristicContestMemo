...
(:warning:今回、どこで差がでているかまだよくわかっていないので、あとで追記・修正したい)

- 探索と活用のバランスを取りながら、硬いところをできるだけ回避してルートを作る、のが難しい問題
- ざっくり、「格子点や不確実性が高いなどのマスを試掘し、その情報から地図を作成し、水路ルートを更新、を繰り返す」方法が強かった模様
- また今回は、結構似たようなアプローチを取った人が多かったため、細かい調整の違いやパラメータ調整具合でかなり順位に差がでていた可能性がある
...
- optuna
  - ただし、"自動"チューニングツールを使うことに対する批判もある
...
- [5位phocomさん](https://twitter.com/_phocom/status/1629787101779869698)
  ...
  - https://twitter.com/_phocom/status/1630205013187338240
- [6位arvindf232さん](https://atcoder.jp/contests/ahc018/editorial/5883)
- [7位yosssさん](https://twitter.com/yos1up/status/1629827983187013632)
- [8位iwashi31さん](https://twitter.com/iwashi31/status/1629784139850477569)
...
- [9位saharanさん](https://twitter.com/shr_pc/status/1629788223189954560)
...
- 10位gazelleさん
- [11位gasinさん](https://twitter.com/_gacin/status/1629796478528163840)
  - https://twitter.com/_gacin/status/1629931267008651266
- 12位madouさん
- [13位Kiri8128さん](https://twitter.com/kiri8128/status/1629785480337436674)
